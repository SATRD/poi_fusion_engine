...
-- this corresponds to base part (taken from fe_base_reset without the data-----------------------------------------------
...
--------------------------------------------------------------------------------------------------------------------------------
-- this corresponds to ocd part  again------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------
...
ALTER TABLE Labeltype ADD CONSTRAINT labeltype_name_uk UNIQUE (name);
...
/*It's recommended update the database statistics launching: VACUUM ANALYZE poi;*/
/*This instruction can't be executed in a multicommand DDL*/
...
ALTER TABLE poicomponent ADD CONSTRAINT POIComponent_POILabel FOREIGN KEY (poilabelid) REFERENCES poilabel(id) MATCH SIMPLE ON DELETE NO ACTION ON UPDATE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE poicomponent ADD CONSTRAINT POIComponent_Component FOREIGN KEY (componentid) REFERENCES component(id) MATCH SIMPLE ON DELETE NO ACTION ON UPDATE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE;
