...
public class POICategory {
	...
	public static POICategory getPOICategoryClassByPOIIdAndCategoryId(Connection con, Integer poiId,Integer categoryId){
	...
	public static boolean savePOICategory(Connection con, POICategory poicategory){			
		String sql;
	...
	public static boolean deletePOICategoryByPOIidAndCategoryId(Connection con, Integer poiId,Integer categoryId){		
	...
	public static boolean updatePOICategory(Connection con, POICategory poicategory){
	...
	public static void testPOICategory(Connection con) throws ParseException{
		...
		boolean bool = POICategory.savePOICategory(con, poicategory);
		if (!bool){
			...
			POICategory poicategory2 = POICategory.getPOICategoryClassByPOIIdAndCategoryId(con, poiId, categoryId);
			if (poicategory2==null){
				...
				if (!POICategory.deletePOICategoryByPOIidAndCategoryId(con, poiId, categoryId)){
