...
public class POISource {
	...
	public static POISource getPOISourceClassByPOIId(Connection con, Integer poiid){
	...
	public static POISource getPOISourceClassByPOIIdAndSourceIdAndPoiproxyAttribute(Connection con, 
			Integer poiid, Integer sourceId, String poiproxyattribute){
		POISource poisource = null;
		Statement stmt;
		ResultSet rs;
		ArrayList<HashMap<String, Object>> list;
	...
	public static POISource getPOISourceClassBySourceIdAndOriginalRefAndPoiproxyAttribute(Connection con, 
			Integer sourceId, String originalRef,String poiproxyattribute){
		...
		try {
			...
			System.out.println("Error POISource.getPOISourceClassByName() : "+e.getMessage());
			log.error("Error POISource.getPOISourceClassByName() : "+e.getMessage());
		}
	...
	public static boolean savePOISource(Connection con, POISource poisource){
	...
	public static ArrayList<POISource> getPOISourceList (Connection con){
	...
	public static void testPOISource(Connection con) throws ParseException {
		...
		if (!POISource.savePOISource(con, poisource)){
			...
			POISource poisource2 = POISource.getPOISourceClassBySourceIdAndOriginalRefAndPoiproxyAttribute(con, sourceId, originalRef, poiproxyattribute);
			if (poisource2==null){
				...
				poisource2 = POISource.getPOISourceClassByPOIIdAndSourceIdAndPoiproxyAttribute(con, poiId, sourceId, poiproxyattribute);
				if (poisource2 == null){
					...
					if (!POISource.deletePOISourceByPOIIdAndSourceIdAndPoiproxyAttribute(con, poiId, sourceId, poiproxyattribute)){
